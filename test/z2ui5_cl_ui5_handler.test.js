...
jest.mock("../core/srv/z2ui5/01/01/z2ui5_cl_ui5_srv_draft", () => {
  const actual = jest.requireActual("../core/srv/z2ui5/01/01/z2ui5_cl_ui5_srv_draft");
...
describe("z2ui5_cl_ui5_handler", () => {
  ...
  describe("app loading from DB", () => {
    test("loads app from DB when ID is provided", async () => {
      ...
      expect(result.S_FRONT.APP).toBe("z2ui5_cl_ui5_app_hi_world");
    });
