// GENERATED from run/input/abap2UI5/src/01/02/z2ui5_cl_ui5_app_cont.clas.testclasses.abap — do not edit
...
class ltcl_test {
  test_instantiation() {
    let lo_app = null;
    lo_app = new z2ui5_cl_ui5_app_cont();
  ...
  test_buffer_clear() {
    ...
    cl_abap_unit_assert.assert_equals({ exp: 0, act: z2ui5_cl_ui5_app_cont.mt_buffer.length });
  }
}
...
class ltcl_test_db extends z2ui5_if_app {
  ...
  test_db_save_complex() {
    ...
    lo_app.db_save();
    cl_abap_unit_assert.assert_equals({ exp: true, act: lo_app.mv_check_initialized });
    temp3 = z2ui5_cl_util.abap_cast(lo_app.mo_app);
    cl_abap_unit_assert.assert_equals({ exp: `TEST_COMPLEX`, act: temp3.id_draft });
  }
