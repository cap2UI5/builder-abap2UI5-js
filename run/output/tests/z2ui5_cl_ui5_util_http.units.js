// GENERATED from run/input/abap2UI5/src/00/03/z2ui5_cl_ui5_util_http.clas.testclasses.abap — do not edit
const cl_abap_unit_assert = require("abap2UI5/cl_abap_unit_assert");
const z2ui5_cl_ui5_util_http = require("abap2UI5/z2ui5_cl_ui5_util_http");
...
class ltcl_test {
  ...
  setup() {
    ...
    this.mo_cut = z2ui5_cl_ui5_util_http.factory({ server: this.mo_server });
  }
  ...
  test_factory_cloud() {
    const lo_cut = z2ui5_cl_ui5_util_http.factory_cloud({ req: new ltcl_fake_request(), res: new ltcl_fake_response() });
