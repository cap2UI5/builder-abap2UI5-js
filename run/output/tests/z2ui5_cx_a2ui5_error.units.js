// GENERATED from run/input/abap2UI5/src/00/03/z2ui5_cx_a2ui5_error.clas.testclasses.abap — do not edit
...
class ltcl_unit_test {
  ...
  test_chain_texts() {
    const lx_inner = new z2ui5_cx_a2ui5_error({ val: `inner` });
    const lx_middle = new z2ui5_cx_a2ui5_error({ val: `middle`, previous: lx_inner });
    const lx_outer = new z2ui5_cx_a2ui5_error({ val: `outer`, previous: lx_middle });
