...
module.exports = {
  ...
  __tests: {"ltcl_test_http_handler":["test_http_get_status","test_http_get_html","test_http_get_ui5_boot","test_http_post_ok","test_http_post_error","test_main_post_no_app","test_main_get_routing","test_main_post_routing","test_main_unsupported","test_post_no_s_front","test_csrf_inactive","test_csrf_same_origin","test_csrf_cross_origin","test_csrf_no_headers","test_csrf_referer","test_preload_escaping","test_preload_literals"]},
};
