// GENERATED from run/input/abap2UI5/src/00/03/z2ui5_cl_ui5_util_json_fl.clas.testclasses.abap — do not edit
const cl_abap_unit_assert = require("abap2UI5/cl_abap_unit_assert");
const z2ui5_cl_ui5_util_json_fl = require("abap2UI5/z2ui5_cl_ui5_util_json_fl");
...
class ltcl_test {
  ...
  setup() {
    this.mi_filter = z2ui5_cl_ui5_util_json_fl.create_no_empty_values();
  }

  keep_node({ iv_type, iv_value = ``, iv_children = 0, iv_visit = z2ui5_if_ajson_filter.visit_type.value } = {}) {
    let rv_keep = false;
...
module.exports = {
  __main: "z2ui5_cl_ui5_util_json_fl",
  __classes: { ltcl_test },
