...
class z2ui5_cl_smp_context {
  ...
  static class_constructor() {
    z2ui5_cl_smp_context.cv_char_util_newline = z2ui5_cl_util.abap_tab_assign(z2ui5_cl_smp_context.cv_char_util_newline, z2ui5_cl_util.abap_copy(cl_abap_char_utilities.newline));
    z2ui5_cl_smp_context.cv_char_util_cr_lf = z2ui5_cl_util.abap_tab_assign(z2ui5_cl_smp_context.cv_char_util_cr_lf, z2ui5_cl_util.abap_copy(cl_abap_char_utilities.cr_lf));
    z2ui5_cl_smp_context.cv_char_util_horizontal_tab = z2ui5_cl_util.abap_tab_assign(z2ui5_cl_smp_context.cv_char_util_horizontal_tab, z2ui5_cl_util.abap_copy(cl_abap_char_utilities.horizontal_tab));
    z2ui5_cl_smp_context.cv_char_util_charsize = z2ui5_cl_util.abap_tab_assign(z2ui5_cl_smp_context.cv_char_util_charsize, z2ui5_cl_util.abap_copy(cl_abap_char_utilities.charsize));
    z2ui5_cl_smp_context.cv_format_e_xml_attr = z2ui5_cl_util.abap_tab_assign(z2ui5_cl_smp_context.cv_format_e_xml_attr, z2ui5_cl_util.abap_copy(cl_abap_format.e_xml_attr));
    z2ui5_cl_smp_context.cv_typedescr_typekind_table = z2ui5_cl_util.abap_tab_assign(z2ui5_cl_smp_context.cv_typedescr_typekind_table, z2ui5_cl_util.abap_copy(cl_abap_typedescr.typekind_table));
    z2ui5_cl_smp_context.cv_typedescr_typekind_dref = z2ui5_cl_util.abap_tab_assign(z2ui5_cl_smp_context.cv_typedescr_typekind_dref, z2ui5_cl_util.abap_copy(cl_abap_typedescr.typekind_dref));
    z2ui5_cl_smp_context.cv_typedescr_typekind_oref = z2ui5_cl_util.abap_tab_assign(z2ui5_cl_smp_context.cv_typedescr_typekind_oref, z2ui5_cl_util.abap_copy(cl_abap_typedescr.typekind_oref));
    z2ui5_cl_smp_context.cv_typedescr_typekind_struct1 = z2ui5_cl_util.abap_tab_assign(z2ui5_cl_smp_context.cv_typedescr_typekind_struct1, z2ui5_cl_util.abap_copy(cl_abap_typedescr.typekind_struct1));
    z2ui5_cl_smp_context.cv_typedescr_typekind_struct2 = z2ui5_cl_util.abap_tab_assign(z2ui5_cl_smp_context.cv_typedescr_typekind_struct2, z2ui5_cl_util.abap_copy(cl_abap_typedescr.typekind_struct2));
    z2ui5_cl_smp_context.cv_typedescr_kind_struct = z2ui5_cl_util.abap_tab_assign(z2ui5_cl_smp_context.cv_typedescr_kind_struct, z2ui5_cl_util.abap_copy(cl_abap_typedescr.kind_struct));
    z2ui5_cl_smp_context.cv_typedescr_kind_ref = z2ui5_cl_util.abap_tab_assign(z2ui5_cl_smp_context.cv_typedescr_kind_ref, z2ui5_cl_util.abap_copy(cl_abap_typedescr.kind_ref));
    z2ui5_cl_smp_context.cv_objectdescr_public = z2ui5_cl_util.abap_tab_assign(z2ui5_cl_smp_context.cv_objectdescr_public, z2ui5_cl_util.abap_copy(cl_abap_objectdescr.public));
  }

  static boolean_abap_2_json({ val } = {}) {
    let result = ``;
    if (z2ui5_cl_smp_context.boolean_check_by_data({ val: val })) {
  ...
  static boolean_check_by_data({ val } = {}) {
    ...
    try {
      ...
      lr_cache = {};
      {
        const _t = z2ui5_cl_smp_context.mt_bool_cache;
      ...
      lo_ele = (lo_descr);
      result = z2ui5_cl_smp_context.boolean_check_by_name({ val: lo_ele.get_relative_name() });
      z2ui5_cl_smp_context.mt_bool_cache.push(z2ui5_cl_util.abap_copy({ absolute_name: lv_abs_name, is_bool: result }));
    } catch (error) {
    }
    return result;
  }
  ...
  static c_trim({ val } = {}) {
    ...
    result = this.shift_right({ val: result, sub: z2ui5_cl_smp_context.cv_char_util_horizontal_tab });
    result = (result.startsWith(z2ui5_cl_smp_context.cv_char_util_horizontal_tab) ? result.slice((z2ui5_cl_smp_context.cv_char_util_horizontal_tab).length) : result);
  ...
  static c_trim_lower({ val } = {}) {
    let result = ``;
    result = z2ui5_cl_smp_context.c_trim({ val: (val) }).toLowerCase();
    return result;
  }

  static c_trim_upper({ val } = {}) {
    let result = ``;
    result = z2ui5_cl_smp_context.c_trim({ val: (val) }).toUpperCase();
    return result;
  }
  ...
  static filter_itab(_args = {}) {
    ...
    for (const ref of val) {
      ...
      for (const ls_filter of filter) {
        sy_tabix++;
        _fs$fs_field = ((_o, _n) => { if (_o == null) return null; const _k = String(_n).toLowerCase(); return _k in _o ? { o: _o, k: _k } : null; })(ref, ls_filter.name);
  ...
  static filter_get_multi_by_data({ val } = {}) {
    ...
    let sy_tabix = 0;
    sy_tabix = 0;
    for (const lr_comp of z2ui5_cl_smp_context.rtti_get_t_attri_by_any({ val: val })) {
      sy_tabix++;
  ...
  static filter_get_range_t_by_token_t({ val } = {}) {
    ...
    for (const ls_token of val) {
      sy_tabix++;
      result.push(z2ui5_cl_util.abap_copy(z2ui5_cl_smp_context.filter_get_range_by_token({ val: ls_token.text })));
    }
    return result;
  }
  ...
  static filter_get_token_t_by_range_t({ val } = {}) {
    ...
    let sy_tabix = 0;
    let lv_value;
    const lt_mapping = z2ui5_cl_smp_context.filter_get_token_range_mapping();
    let lt_tab = {};
    const _out0 = { val, tab: lt_tab };
    z2ui5_cl_smp_context.itab_corresponding(_out0);
  ...
  static itab_get_csv_by_itab({ val } = {}) {
    ...
    result = lt_lines.join(z2ui5_cl_smp_context.cv_char_util_cr_lf);
    return result;
  }
  ...
  static itab_get_itab_by_csv({ val } = {}) {
    ...
    let lt_comp = [];
    let lr_row = null;
    let lt_rows = val.split(z2ui5_cl_smp_context.cv_char_util_newline);
    let lt_cols = lt_rows[(1) - 1].split(`;`);
    sy_tabix = 0;
    for (const lr_col of lt_cols) {
      sy_tabix++;
      lv_name = z2ui5_cl_smp_context.c_trim_upper({ val: lr_col });
    ...
    for (const lr_rows of lt_rows) {
      ...
      for (const lr_col of lt_cols) {
        ...
        fs_field = z2ui5_cl_util.abap_tab_assign(fs_field, z2ui5_cl_util.abap_copy(lr_col));
  ...
  static json_parse(_args = {}) {
    ...
    try {
      ...
      x = _caught1;
      throw new z2ui5_cx_smp_error({ val: x });
    }
  ...
  static rtti_get_t_attri_by_include() {
    ...
    try {
      ...
      x = _caught1;
      throw new z2ui5_cx_smp_error({ previous: x });
    }
    ...
    for (const lr_comp of comps) {
      ...
      if ((lr_comp.as_include === true || lr_comp.as_include === `X`)) {
        incl_comps = z2ui5_cl_smp_context.rtti_get_t_attri_by_include(lr_comp.type);
        const _sy_tabix_1 = sy_tabix;
        sy_tabix = 0;
  ...
  static rtti_get_t_attri_by_any({ val } = {}) {
    ...
    let lr_cache = {};
    {
      const _t = z2ui5_cl_smp_context.mt_attri_cache;
    ...
    for (const lr_comp of comps) {
      ...
      if (!(lr_comp.as_include === true || lr_comp.as_include === `X`)) {
        ...
        lt_attri = z2ui5_cl_smp_context.rtti_get_t_attri_by_include(lr_comp.type);
    ...
    if (lr_cache != null) {
      ...
      z2ui5_cl_smp_context.mt_attri_cache.push(z2ui5_cl_util.abap_copy({ absolute_name: lv_absolute_name, o_struct: lo_struct, t_attri: result }));
    }
    return result;
  }
  ...
  static url_param_get({ val, url } = {}) {
    let result = ``;
    const lt_params = z2ui5_cl_smp_context.url_param_get_tab({ i_val: url });
    const lv_val = z2ui5_cl_smp_context.c_trim_lower({ val: val });
  ...
  static url_param_get_tab({ i_val } = {}) {
    ...
    lv_search2 = this.substring_after({ val: z2ui5_cl_smp_context.c_trim_lower({ val: lv_search }), sub: `?` });
    if (lv_search2) {
  ...
  static xml_srtti_stringify({ data } = {}) {
    ...
    if ((z2ui5_cl_smp_context.rtti_check_class_exists({ val: `ZCL_SRTTI_TYPEDESCR` }) === true || z2ui5_cl_smp_context.rtti_check_class_exists({ val: `ZCL_SRTTI_TYPEDESCR` }) === `X`)) {
      ...
      try {
        ...
        throw new z2ui5_cx_smp_error({ val: lv_text });
      }
    }
    return result;
  }
  ...
  static rtti_get_t_attri_by_table_name({ table_name } = {}) {
    ...
    let lt_attri;
    if (!table_name) {
      throw new z2ui5_cx_smp_error({ val: `TABLE_NAME_INITIAL_ERROR` });
    }
    try {
      ...
      if (sy_subrc !== 0) {
        throw new z2ui5_cx_smp_error({ val: `TABLE_NOT_FOUD_NAME___${table_name}` });
      }
      lo_struct = (lo_obj);
    } catch (error) {
      try {
  ...
  static msg_get_t() {
    ...
    if (!result && val2) {
      result = z2ui5_cl_smp_context.msg_get_internal({ val: val2 });
    }
    return result;
  }
  ...
  static rtti_get_t_attri_on_prem({ tabname } = {}) {
    ...
    let comp = null;
    comps = z2ui5_cl_util.abap_tab_assign(comps, z2ui5_cl_util.abap_copy(temp9));
    temp10 = z2ui5_cl_util.abap_cast(cl_abap_structdescr.describe_by_name(`DFIES`));
    lo_struct = temp10;
    ...
    try {
      ...
      if (!tabname) {
        throw new z2ui5_cx_smp_error({ val: `RTTI_BY_NAME_TAB_INITIAL` });
      }
      structdescr = z2ui5_cl_util.abap_cast(cl_abap_structdescr.describe_by_name(tabname));
      ...
      for (const fs_line of fs_dfies) {
        ...
        for (const comp of comps) {
          ...
          fs_value_dest = z2ui5_cl_util.abap_tab_assign(fs_value_dest, z2ui5_cl_util.abap_copy(fs_value));
        ...
        s_dfies = { tabname: ``, fieldname: ``, langu: ``, position: ``, offset: ``, domname: ``, rollname: ``, checktable: ``, leng: ``, intlen: ``, outputlen: ``, decimals: ``, datatype: ``, inttype: ``, reftable: ``, reffield: ``, precfield: ``, authorid: ``, memoryid: ``, logflag: ``, mask: ``, masklen: ``, convexit: ``, headlen: ``, scrlen1: ``, scrlen2: ``, scrlen3: ``, fieldtext: ``, reptext: ``, scrtext_s: ``, scrtext_m: ``, scrtext_l: ``, keyflag: ``, lowercase: ``, mac: ``, genkey: ``, noforkey: ``, valexi: ``, noauthch: ``, sign: ``, dynpfld: ``, f4availabl: ``, comptype: ``, lfieldname: ``, ltrflddis: ``, bidictrlc: ``, outputstyle: ``, nohistory: ``, ampmformat: `` };
      }
    } catch (error) {
    }
    return result;
  ...
  static rtti_get_t_attri_on_cloud({ tabname } = {}) {
    ...
    let names = [];
    lv_tabname = z2ui5_cl_util.abap_tab_assign(lv_tabname, z2ui5_cl_util.abap_copy(tabname));
    try {
      try {
        ...
        _fs$fs_any = ((_o, _n) => { if (_o == null) return null; const _k = String(_n).toLowerCase(); return _k in _o ? { o: _o, k: _k } : null; })(obj, `IF_XCO_DATABASE_TABLE~FIELDS->IF_XCO_DBT_FIELDS_FACTORY~KEY`);
        ...
        {
          const _dynr = (obj);
          const _dynm = _dynr ? _dynr[String(`IF_XCO_DBT_FIELDS~GET_NAMES`).toLowerCase()] : undefined;
          if (typeof _dynm !== "function") throw new Error(`CALL METHOD: ${String(`IF_XCO_DBT_FIELDS~GET_NAMES`)} not found`);
          {
            const _dynargs = {  };
            const _dynret = _dynm.call(_dynr, _dynargs);
            names = _dynret !== undefined ? _dynret : _dynargs.rt_names;
          }
        }
      } catch (error) {
        workaround = `DDFIELDS`;
        // TODO(abap2js): CREATE DATA lr_ddfields TYPE (workaround).
        fs_ddfields = lr_ddfields;
        _fs$fs_ddfields = null;
        sy_subrc = 0;
    ...
    const lt_comp = z2ui5_cl_smp_context.rtti_get_t_attri_by_any({ val: tabname });
    sy_tabix = 0;
  ...
  static rtti_get_t_dfies_by_table_name({ table_name } = {}) {
    let result = [];
    if (z2ui5_cl_smp_context.context_check_abap_cloud()) {
      result = z2ui5_cl_smp_context.rtti_get_t_attri_on_cloud({ tabname: table_name });
    } else {
      result = z2ui5_cl_smp_context.rtti_get_t_attri_on_prem({ tabname: table_name });
    }
    return result;
  }
  ...
  static context_check_abap_cloud() {
    let result = false;
    if ((z2ui5_cl_smp_context.gv_check_cloud_cached === true || z2ui5_cl_smp_context.gv_check_cloud_cached === `X`)) {
      result = z2ui5_cl_util.abap_tab_assign(result, z2ui5_cl_util.abap_copy(z2ui5_cl_smp_context.gv_check_cloud));
      return result;
    }
    try {
      cl_abap_typedescr.describe_by_name(`T100`);
      z2ui5_cl_smp_context.gv_check_cloud = false;
    } catch (error) {
      z2ui5_cl_smp_context.gv_check_cloud = true;
    }
    z2ui5_cl_smp_context.gv_check_cloud_cached = true;
    result = z2ui5_cl_util.abap_tab_assign(result, z2ui5_cl_util.abap_copy(z2ui5_cl_smp_context.gv_check_cloud));
    return result;
  }
  ...
  static rtti_check_clike({ val } = {}) {
    let result = false;
    const lv_type = z2ui5_cl_smp_context.rtti_get_type_kind({ val: val });
    switch (lv_type) {
    ...
    switch (lv_kind) {
      case cl_abap_datadescr.typekind_table:
        ...
        for (const symbol of fs_tab) {
          sy_tabix++;
          lt_tab = z2ui5_cl_smp_context.msg_get_internal({ val: fs_row });
      ...
      case cl_abap_datadescr.typekind_struct2:
        ...
        if ((z2ui5_cl_smp_context.check_is_rap_struct({ val: val }) === true || z2ui5_cl_smp_context.check_is_rap_struct({ val: val }) === `X`)) {
          result = z2ui5_cl_smp_context.msg_get_rap({ val: val });
          return result;
        }
        lt_attri = z2ui5_cl_smp_context.rtti_get_t_attri_by_any({ val: val });
        ls_result = {};
        sy_tabix = 0;
        for (const ls_attri of lt_attri) {
          ...
          if (ls_attri.name === `ITEM`) {
            lt_tab = z2ui5_cl_smp_context.msg_get_internal({ val: fs_comp });
            result.push(...lt_tab.map((_r) => z2ui5_cl_util.abap_copy(_r)));
            return result;
          } else {
            ls_result = z2ui5_cl_smp_context.msg_map({ name: ls_attri.name, val: fs_comp, is_msg: ls_result });
          }
        }
      ...
      case cl_abap_datadescr.typekind_oref:
        result = z2ui5_cl_smp_context.msg_get_by_oref({ val: val });
        break;
      default:
        if (z2ui5_cl_smp_context.rtti_check_clike({ val: val })) {
  ...
  static msg_get_by_oref({ val } = {}) {
    ...
    try {
      ...
      lt_attri_o = z2ui5_cl_smp_context.rtti_get_t_attri_by_oref({ val: val });
      sy_tabix = 0;
      for (const ls_attri_o of lt_attri_o) {
        ...
        ls_result = z2ui5_cl_smp_context.msg_map({ name: ls_attri_o.name, val: fs_comp, is_msg: ls_result });
      }
      result.push(z2ui5_cl_util.abap_copy(ls_result));
    } catch (error) {
      let obj = null;
      ...
      try {
        ...
        lt_tab2 = z2ui5_cl_smp_context.msg_get_internal({ val: fs_tab2 });
  ...
  static check_is_rap_struct({ val } = {}) {
    ...
    let lo_line;
    let lt_comps;
    const lt_attri = z2ui5_cl_smp_context.rtti_get_t_attri_by_any({ val: val });
    sy_tabix = 0;
    for (const ls_attri of lt_attri) {
      sy_tabix++;
    ...
    for (const ls_attri of lt_attri) {
      ...
      if (!(z2ui5_cl_smp_context.rtti_get_type_kind({ val: fs_tab }) === cl_abap_datadescr.typekind_table)) continue;
      try {
  ...
  static msg_get_rap({ val, entity_name } = {}) {
    ...
    z2ui5_cl_smp_context.msg_get_rap_row(_out0);
    ...
    for (const ls_attri of lt_attri) {
      ...
      for (const symbol of fs_ftab) {
        ...
        if (z2ui5_cl_smp_context.rtti_get_type_kind({ val: fs_row }) === cl_abap_datadescr.typekind_oref) {
          ...
          result.push(...z2ui5_cl_smp_context.msg_get_rap({ val: fs_row, entity_name: ls_attri.name }).map((_r) => z2ui5_cl_util.abap_copy(_r)));
        }
      }
  ...
  static msg_get_rap_tky({ val } = {}) {
    ...
    result = z2ui5_cl_smp_context.msg_get_rap_flatten({ val: fs_tky });
    return result;
  }
  ...
  static msg_get_rap_flatten({ val } = {}) {
    ...
    for (const ls_attri of lt_attri) {
      ...
      sy_subrc = _fs$fs_comp ? 0 : 4;
      if (!(sy_subrc === 0)) continue;
      lv_sub_kind = z2ui5_cl_smp_context.rtti_get_type_kind({ val: fs_comp });
      if (lv_sub_kind === cl_abap_datadescr.typekind_struct1 || lv_sub_kind === cl_abap_datadescr.typekind_struct2) {
        lv_sub = z2ui5_cl_smp_context.msg_get_rap_flatten({ val: fs_comp });
        if (lv_sub) {
          if (result) {
            result = `${result}, `;
          }
  ...
  static msg_get_rap_meta({ val } = {}) {
    let result = [];
    let lv = ``;
    lv = z2ui5_cl_smp_context.msg_get_rap_element({ val: val });
    if (lv) {
      result.push(z2ui5_cl_util.abap_copy({ n: `element`, v: lv }));
    }
    lv = z2ui5_cl_smp_context.msg_get_rap_state_area({ val: val });
    if (lv) {
      result.push(z2ui5_cl_util.abap_copy({ n: `state_area`, v: lv }));
    }
    lv = z2ui5_cl_smp_context.msg_get_rap_action({ val: val });
    if (lv) {
      result.push(z2ui5_cl_util.abap_copy({ n: `action`, v: lv }));
    }
    lv = z2ui5_cl_smp_context.msg_get_rap_pid({ val: val });
    if (lv) {
      result.push(z2ui5_cl_util.abap_copy({ n: `pid`, v: lv }));
    }
    lv = z2ui5_cl_smp_context.msg_get_rap_cid({ val: val });
    if (lv) {
      result.push(z2ui5_cl_util.abap_copy({ n: `cid`, v: lv }));
    }
    lv = z2ui5_cl_smp_context.msg_get_rap_tky({ val: val });
    if (lv) {
...
module.exports = z2ui5_cl_smp_context;
...
// TODO(abap2js): unresolved reference z2ui5_cx_smp_error — add require manually

z2ui5_cl_smp_context.class_constructor();
