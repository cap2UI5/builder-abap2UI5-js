...
class z2ui5_cl_smp_app_011 extends z2ui5_if_app {
  ...
  view_display() {
    ...
    page.tag(`MessageStrip`)
      .a({ n: `text`, v: `A MultiSelect table whose input cells switch between display and edit mode via the ` + `toolbar, which also adds new rows and deletes the currently selected ones.` })
      .a({ n: `type`, v: `Information` })
      .a({ n: `showIcon`, b: true })
      .a({ n: `class`, v: `sapUiSmallMargin` });
    const tab = page.ele(`Table`)
      .a({ n: `items`, v: `{path: '${this.client._bind(this.t_tab, { path: true })}', templateShareable: false}` })
