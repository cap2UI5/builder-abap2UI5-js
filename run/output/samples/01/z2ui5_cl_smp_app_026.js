...
class z2ui5_cl_smp_app_026 extends z2ui5_if_app {
  product = ``;
  quantity = ``;
  placement = ``;
  client = null;
  ...
  view_display() {
    ...
    page.tag(`MessageStrip`)
      .a({ n: `text`, v: `Popover demo: choose a placement with the segmented button, then open a popover ` + `anchored to a control, with confirm and cancel actions.` })
    ...
    page.ele({ n: `SimpleForm`, ns: `form` })
      ...
      .ele(`SegmentedButton`)
      .a({ n: `selectedKey`, v: this.client._bind(this.placement) })
      .ele(`items`)
...
module.exports = z2ui5_cl_smp_app_026;
