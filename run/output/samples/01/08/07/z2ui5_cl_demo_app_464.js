...
class z2ui5_cl_demo_app_464 extends z2ui5_if_app {
  ...
  view_display({ client } = {}) {
    ...
    const page = view.shell()
      .page({ title: `abap2UI5 - Sample: Object Header Responsive II`, navbuttonpress: client._event_nav_app_leave(), shownavbutton: client.check_app_prev_stack() });
    page.header_content()
      .link({ text: `UI5 Demo Kit`, target: `_blank`, href: `https://sapui5.hana.ondemand.com/sdk/#/entity/sap.m.ObjectHeader/sample/sap.m.sample.ObjectHeaderResponsiveII` });
    const header = page.object_header({ responsive: true, fullscreenoptimized: false, intro: `Notebook Basic 15 with 2,80 GHz quad core, 15" LCD, 4 GB DDR3 RAM, 500 GB Hard Disc, Windows 8 Pro`, title: `Long title truncated to 80 chars on all devices and to 50 chars on phone portrait`, number: `956.00`, numberunit: `EUR`, numberstate: `Success`, backgrounddesign: `Translucent`, class: `sapUiResponsivePadding--header` });
    ...
    const items = header._generic(`headerContainer`)
      .icon_tab_bar({ id: `itb1`, selectedkey: `key3`, uppercase: true, class: `sapUiResponsiveContentPadding` })
      .items();
