...
class z2ui5_cl_demo_app_453 extends z2ui5_if_app {
  ...
  view_display({ client } = {}) {
    const page = z2ui5_cl_xml_view.factory()
      .shell()
      .page({ title: `abap2UI5 - Sample: MultiComboBox - Two columns layout`, navbuttonpress: client._event_nav_app_leave(), shownavbutton: client.check_app_prev_stack() });
    page.header_content()
      .link({ text: `UI5 Demo Kit`, target: `_blank`, href: `https://sapui5.hana.ondemand.com/sdk/#/entity/sap.m.MultiComboBox/sample/sap.m.sample.MultiComboBoxTwoColumnsLayout` });
    page.vertical_layout({ class: `sapUiContentPadding`, width: `100%` })
      .multi_combobox({ showsecondaryvalues: true, width: `500px`, items: client._bind(this.t_products) })
      .list_item({ key: `{PRODUCT_ID}`, text: `{NAME}`, additionaltext: `{PRODUCT_ID}` });
