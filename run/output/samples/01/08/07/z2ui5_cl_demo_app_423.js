...
class z2ui5_cl_demo_app_423 extends z2ui5_if_app {
  t_countries = [];
  client = null;
  ...
  view_display({ client } = {}) {
    ...
    const page = z2ui5_cl_xml_view.factory()
      .shell()
      .page({ title: `abap2UI5 - Sample: Combo box`, navbuttonpress: client._event_nav_app_leave(), shownavbutton: client.check_app_prev_stack() });
    page.header_content()
      .link({ text: `UI5 Demo Kit`, target: `_blank`, href: `https://sapui5.hana.ondemand.com/sdk/#/entity/sap.m.ComboBox/sample/sap.m.sample.ComboBox` });
    page.page({ showheader: false, class: `sapUiContentPadding` })
      .combobox({ items: client._bind(this.t_countries) })
...
module.exports = z2ui5_cl_demo_app_423;
