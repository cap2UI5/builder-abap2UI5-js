...
class z2ui5_cl_demo_app_475 extends z2ui5_if_app {
  t_products = [];
  client = null;
  ...
  view_display() {
    ...
    const page = view.shell()
      .page({ title: `abap2UI5 - Sample: SelectList`, navbuttonpress: this.client._event_nav_app_leave(), shownavbutton: this.client.check_app_prev_stack() });
    page.header_content()
      .link({ text: `UI5 Demo Kit`, target: `_blank`, href: `https://sapui5.hana.ondemand.com/sdk/#/entity/sap.m.SelectList/sample/sap.m.sample.SelectList` });
...
module.exports = z2ui5_cl_demo_app_475;
