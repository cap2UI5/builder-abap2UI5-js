...
class z2ui5_cl_demo_app_407 extends z2ui5_if_app {
  client = null;
  ...
  view_display() {
    ...
    const tab = vbox.ui_table({ selectionmode: `MultiToggle`, visiblerowcountmode: `Auto`, rowheight: `32` });
    tab.ui_extension()
      .overflow_toolbar()
    ...
    tab.ui_columns().ui_column().get_parent().ui_column().get_parent().ui_column();
    tab.layout_data(`table`)
      .flex_item_data({ growfactor: `1`, basesize: `0%`, styleclass: `sapUiResponsiveContentPadding` });
    page2.footer()
      .overflow_toolbar()
      .content()
      .toolbar_spacer()
...
module.exports = z2ui5_cl_demo_app_407;
