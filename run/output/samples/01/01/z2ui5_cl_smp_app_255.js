...
class z2ui5_cl_smp_app_255 extends z2ui5_if_app {
  client = null;
  ...
  view_display({ client } = {}) {
    ...
    const page = view.shell()
      .page({ title: `abap2UI5 - Flex Box - Navigation Examples`, navbuttonpress: client._event_nav_app_leave(), shownavbutton: client.check_app_prev_stack() });
    page.header_content()
  ...
  popover_display({ id } = {}) {
    ...
    view.quick_view({ placement: `Bottom`, width: `auto` })
      .quick_view_page({ pageid: `sampleInformationId`, header: `Sample information`, description: `Here is an example of how you can use navigation items as unordered list items in a Flex Box.` });
...
module.exports = z2ui5_cl_smp_app_255;
