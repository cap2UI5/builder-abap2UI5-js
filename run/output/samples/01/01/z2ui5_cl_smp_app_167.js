...
class z2ui5_cl_smp_app_167 extends z2ui5_if_app {
  ...
  set_view() {
    ...
    page.input(this.client._bind(this.mv_value));
    page.button({ text: `EVENT_MODEL_VALUE`, press: this.client._event(`EVENT_MODEL_VALUE`, [`$` + this.client._bind(this.mv_value)]) });
