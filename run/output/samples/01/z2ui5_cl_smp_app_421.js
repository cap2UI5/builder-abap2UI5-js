  ...
  view_display() {
    ...
    for (const row of this.t_tab) {
      ...
      items.ele(`ColumnListItem`)
        ...
        .tag(`Input`)
        .a({ n: `id`, t: `${z2ui5_cl_smp_app_421.cs_column.title}_${i}` })
        .a({ n: `value`, v: `{${path}/${i}/TITLE}` })
        .a({ n: `submit`, v: this.client._event(`NEXT`) })
        .tag(`Input`)
        .a({ n: `id`, t: `${z2ui5_cl_smp_app_421.cs_column.color}_${i}` })
        .a({ n: `value`, v: `{${path}/${i}/VALUE}` })
        .a({ n: `submit`, v: this.client._event(`NEXT`) })
        .tag(`Input`)
        .a({ n: `id`, t: `${z2ui5_cl_smp_app_421.cs_column.info}_${i}` })
        .a({ n: `value`, v: `{${path}/${i}/INFO}` })
        .a({ n: `submit`, v: this.client._event(`NEXT`) })
        .tag(`CheckBox`)
        .a({ n: `id`, t: `${z2ui5_cl_smp_app_421.cs_column.checkbox}_${i}` })
        .a({ n: `selected`, v: `{${path}/${i}/CHECKBOX}` })
        .tag(`Input`)
        .a({ n: `id`, t: `${z2ui5_cl_smp_app_421.cs_column.description}_${i}` })
