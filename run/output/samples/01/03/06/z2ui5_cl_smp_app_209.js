...
class z2ui5_cl_smp_app_209 extends z2ui5_if_app {
  view_display({ client } = {}) {
    ...
    const layout = page.scroll_container({ vertical: true, height: `100%` })
      ...
      .info_label({ id: `il1`, text: `2`, colorscheme: `1` })
      .get_parent()
      .get_parent()
      .flex_box({ direction: `Row`, alignitems: `Start`, class: `sapUiTinyMarginBottom` })
      .text({ text: `Color Scheme 2`, class: `sapUiTinyMarginEnd` })
      .info_label({ id: `il2`, text: `5`, colorscheme: `2` })
      .get_parent()
      .get_parent()
      .flex_box({ direction: `Row`, alignitems: `Start`, class: `sapUiTinyMarginBottom` })
      .text({ text: `Color Scheme 3`, class: `sapUiTinyMarginEnd` })
      .info_label({ id: `il3`, text: `12.5`, colorscheme: `3` })
      .get_parent()
      .get_parent()
      .flex_box({ direction: `Row`, alignitems: `Start`, class: `sapUiTinyMarginBottom` })
      .text({ text: `Color Scheme 4`, class: `sapUiTinyMarginEnd` })
      .info_label({ id: `il4`, text: `2K`, colorscheme: `4` })
      .get_parent()
      .get_parent()
      .flex_box({ direction: `Row`, alignitems: `Start`, class: `sapUiTinyMarginBottom` })
      .text({ text: `Color Scheme 5`, class: `sapUiTinyMarginEnd` })
      .info_label({ id: `il5`, text: `text info label`, rendermode: `Loose`, colorscheme: `5` })
      .get_parent()
      .get_parent()
      .flex_box({ direction: `Row`, alignitems: `Start`, class: `sapUiTinyMarginBottom` })
      .text({ text: `Color Scheme 6`, class: `sapUiTinyMarginEnd` })
      .info_label({ id: `il6`, text: `just a long info label`, colorscheme: `6`, width: `140px` })
      .get_parent()
      .get_parent()
      .flex_box({ direction: `Row`, alignitems: `Start`, class: `sapUiTinyMarginBottom` })
      .text({ text: `Color Scheme 7`, class: `sapUiTinyMarginEnd` })
      .info_label({ id: `il7`, text: `label shorter than width`, colorscheme: `7`, width: `250px` })
      .get_parent()
      .get_parent()
      .flex_box({ direction: `Row`, alignitems: `Start`, class: `sapUiTinyMarginBottom` })
      .text({ text: `Color Scheme 8`, class: `sapUiTinyMarginEnd` })
      .info_label({ id: `il8`, text: `with icon`, colorscheme: `8`, icon: `sap-icon://home-share` })
      .get_parent()
      .get_parent()
      .flex_box({ direction: `Row`, alignitems: `Start`, class: `sapUiTinyMarginBottom` })
      .text({ text: `Color Scheme 9`, class: `sapUiTinyMarginEnd` })
      .info_label({ id: `il9`, text: `in warehouse`, colorscheme: `9` })
      .get_parent()
      .get_parent()
      .flex_box({ direction: `Row`, alignitems: `Start`, class: `sapUiTinyMarginBottom` })
      .text({ text: `Any Color Scheme in Display Only Mode`, class: `sapUiTinyMarginEnd` })
      .info_label({ id: `il10`, text: `display only in form`, colorscheme: `1`, displayonly: true });
...
module.exports = z2ui5_cl_smp_app_209;
