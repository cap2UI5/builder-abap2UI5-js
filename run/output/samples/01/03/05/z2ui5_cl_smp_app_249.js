...
class z2ui5_cl_smp_app_249 extends z2ui5_if_app {
  client = null;

  view_display({ client } = {}) {
    const page = z2ui5_cl_xml_view.factory()
      .shell()
      .page({ title: `abap2UI5 - Sample: Splitter Layout - 3 areas`, navbuttonpress: client._event_nav_app_leave(), shownavbutton: client.check_app_prev_stack() });
    page.header_content()
    ...
    const layout = page.splitter({ height: `500px`, width: `100%` })
  ...
  popover_display({ id } = {}) {
    ...
    view.quick_view({ placement: `Bottom`, width: `auto` })
      .quick_view_page({ pageid: `sampleInformationId`, header: `Sample information`, description: `Simple splitter example with three content areas` });
...
module.exports = z2ui5_cl_smp_app_249;
