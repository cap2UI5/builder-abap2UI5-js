...
class z2ui5_cl_smp_app_250 extends z2ui5_if_app {
  client = null;

  view_display({ client } = {}) {
    const page_01 = z2ui5_cl_xml_view.factory()
      .shell()
      .page({ title: `abap2UI5 - Sample: OverflowToolbar - Alignment`, navbuttonpress: client._event_nav_app_leave(), shownavbutton: client.check_app_prev_stack() });
    ...
    const page_02 = page_01.page()
      .invisible_text({ ns: `core`, id: `inputLabel`, text: `Input label` })
      .get_parent()
  ...
  popover_display({ id } = {}) {
    ...
    view.quick_view({ placement: `Bottom`, width: `auto` })
      .quick_view_page({ pageid: `sampleInformationId`, header: `Sample information`, description: `OverflowToolbar and Toolbar are often used for left/right alignment. This is easily achieved with ToolbarSpacer.` });
...
module.exports = z2ui5_cl_smp_app_250;
