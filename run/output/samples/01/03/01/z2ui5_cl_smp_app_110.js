...
class z2ui5_cl_smp_app_110 extends z2ui5_if_app {
  product = ``;
  quantity = ``;
  client = null;
  ...
  view_display() {
    ...
    view.shell()
      ...
      .header_content()
      .link({ text: `UI5 Demo Kit`, target: `_blank`, href: `https://sapui5.hana.ondemand.com/sdk/#/entity/sap.m.MaskInput/sample/sap.m.sample.MaskInput` })
      .get_parent()
      ...
      .get_parent()
      .label(`Promo code`)
      .mask_input({ mask: `**********`, placeholdersymbol: `_`, placeholder: `Latin characters (case insensitive) and numbers` })
      .get()
      .rules()
      .mask_input_rule()
      .get_parent()
...
module.exports = z2ui5_cl_smp_app_110;
