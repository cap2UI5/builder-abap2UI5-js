...
class z2ui5_cl_smp_app_290 extends z2ui5_if_app {
  client = null;
  ...
  view_display({ client } = {}) {
    ...
    page.list({ headertext: `Products` })
      .object_list_item({ title: `Gladiator MX`, type: `Active`, press: client._event(`onListItemPress`, [`\${$source>/title}`]), number: `87.50`, unit: `EUR` })
      .first_status()
      ...
      .get_parent()
      .get_parent()
      .object_list_item({ title: `Hurricane GX`, type: `Active`, press: client._event(`onListItemPress`, [`\${$source>/title}`]), number: `235`, unit: `EUR` })
      .first_status()
      ...
      .get_parent()
      .get_parent()
      .object_list_item({ title: `Power Projector 4713`, type: `Active`, press: client._event(`onListItemPress`, [`\${$source>/title}`]), number: `135`, unit: `EUR` })
      .first_status()
      ...
      .get_parent()
      .get_parent()
      .object_list_item({ title: `Webcam`, type: `Active`, press: client._event(`onListItemPress`, [`\${$source>/title}`]), number: `15`, unit: `EUR` })
      .first_status()
...
module.exports = z2ui5_cl_smp_app_290;
