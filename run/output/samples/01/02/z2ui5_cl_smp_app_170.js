...
class z2ui5_cl_smp_app_170 extends z2ui5_if_app {
  ...
  simple_popup1() {
    ...
    const content = dialog.icon_tab_bar({ selectedkey: this.client._bind(this.mv_selected_key), select: this.client._event_client({ val: this.client.cs_event.control_by_id, view: this.client.cs_view.popup, t_arg: [`NavCon`, `to`, `\${$parameters>/selectedKey}`] }), headermode: `Inline`, expanded: true, expandable: false })
      .items()
