...
class z2ui5_cl_smp_app_088 extends z2ui5_if_app {
  ...
  view_display() {
    ...
    page.icon_tab_header({ selectedkey: this.client._bind(this.mv_selected_key), select: this.client._event_client(this.client.cs_event.control_by_id, [`NavCon`, `to`, `\${$parameters>/selectedKey}`]), mode: `Inline` })
      .items()
