...
class z2ui5_cl_smp_app_279 extends z2ui5_if_app {
  ...
  view_display() {
    ...
    box.input({ id: `input`, value: this.client._bind(this.text_input), submit: this.client._event(`submit`), width: `40rem`, placeholder: `Enter data, submit and navigate back to trigger data loss protection` });
