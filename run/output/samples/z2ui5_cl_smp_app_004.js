  ...
  on_event() {
    ...
    switch (this.client.get_event()) {
      case `BUTTON_ROUNDTRIP`:
        this.client.message_box_display(`server-client roundtrip, method on_event of the abap controller was called ` + `(get( )-check_on_navigated = ${this.client.get().CHECK_ON_NAVIGATED})`);
        break;
      case `BUTTON_RESTART`:
