...
class z2ui5_cl_smp_app_122 extends z2ui5_if_app {
  ...
  read_frontend_info() {
    ...
    this.browser_label = (ls_get.S_DEVICE.BROWSER.NAME === z2ui5_if_client.cs_device.browser.chrome ? `Google Chrome (or Chromium)` : ls_get.S_DEVICE.BROWSER.NAME === z2ui5_if_client.cs_device.browser.firefox ? `Mozilla Firefox` : ls_get.S_DEVICE.BROWSER.NAME === z2ui5_if_client.cs_device.browser.safari ? `Apple Safari` : ls_get.S_DEVICE.BROWSER.NAME === z2ui5_if_client.cs_device.browser.edge ? `Microsoft Edge` : `not one cs_device-browser names`);
    this.os_label = (ls_get.S_DEVICE.OS.NAME === z2ui5_if_client.cs_device.os.windows ? `Windows` : ls_get.S_DEVICE.OS.NAME === z2ui5_if_client.cs_device.os.macintosh ? `macOS` : ls_get.S_DEVICE.OS.NAME === z2ui5_if_client.cs_device.os.linux ? `Linux` : ls_get.S_DEVICE.OS.NAME === z2ui5_if_client.cs_device.os.ios ? `iOS` : ls_get.S_DEVICE.OS.NAME === z2ui5_if_client.cs_device.os.android ? `Android` : `not one cs_device-os names`);
    this.orientation_label = (ls_get.S_DEVICE.ORIENTATION === z2ui5_if_client.cs_device.orientation.portrait ? `portrait - one column would fit best` : ls_get.S_DEVICE.ORIENTATION === z2ui5_if_client.cs_device.orientation.landscape ? `landscape - room for two columns` : `not one cs_device-orientation names`);
  }
  ...
  view_display() {
    ...
    page.tag(`MessageStrip`)
      .a({ n: `text`, v: `Reads frontend information from the client - UI5 version and theme plus device, ` + `OS and browser details - and shows each value in a read-only form. The three labels ` + `are decided with the cs_device constants, the way an app would branch on them.` })
    ...
    page.ele({ n: `SimpleForm`, ns: `form` })
      ...
      .tag(`Input`)
      .a({ n: `enabled`, b: false })
      .a({ n: `value`, v: this.client._bind(this.browser_label) })
      .tag(`Label`)
      .a({ n: `text`, v: `os, by cs_device-os` })
      .tag(`Input`)
      .a({ n: `enabled`, b: false })
      .a({ n: `value`, v: this.client._bind(this.os_label) })
      .tag(`Label`)
      .a({ n: `text`, v: `orientation, by cs_device-orientation` })
      .tag(`Input`)
      .a({ n: `enabled`, b: false })
      .a({ n: `value`, v: this.client._bind(this.orientation_label) })
      .tag(`Label`)
