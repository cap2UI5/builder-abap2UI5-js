...
class z2ui5_cl_smp_app_257 extends z2ui5_if_app {
  client = null;

  view_display({ client } = {}) {
    const page = z2ui5_cl_xml_view.factory()
      .shell()
      .page({ title: `abap2UI5 - Sample: Generic Tag with Different Configurations`, navbuttonpress: client._event_nav_app_leave(), shownavbutton: client.check_app_prev_stack() });
    page.header_content()
    ...
    const layout = page.vertical_layout({ class: `sapUiContentPadding`, width: `100%` })
      ...
      .flex_box({ class: `sapUiTinyMarginBottom`, direction: `Column`, fitcontainer: true, alignitems: `Start`, justifycontent: `Start` })
      ...
      .generic_tag({ text: `Project Cost`, design: `StatusIconHidden`, status: `Error`, valuestate: `Error`, class: `sapUiSmallMarginBottom` })
      .get_parent()
      .get_parent()
      .flex_box({ direction: `Column`, fitcontainer: true, alignitems: `Start`, justifycontent: `Start` })
      .text({ text: `Generic Tag - Situation`, class: `sapUiSmallMarginBottom` })
      .generic_tag({ text: `Shortage Expected`, status: `Warning`, class: `sapUiSmallMarginBottom` })
      .get_parent()
      .generic_tag({ text: `Material Shortage`, status: `Warning`, class: `sapUiSmallMarginBottom` })
      .get_parent()
      .get_parent()
      .flex_box({ direction: `Column`, fitcontainer: true, alignitems: `Start`, justifycontent: `Start` })
  ...
  popover_display({ id } = {}) {
    ...
    view.quick_view({ placement: `Bottom`, width: `auto` })
      .quick_view_page({ pageid: `sampleInformationId`, header: `Sample information`, description: `Previews of the GenericTag control based on combinations of different sets of properties.` });
...
module.exports = z2ui5_cl_smp_app_257;
