...
class z2ui5_cl_smp_app_303 extends z2ui5_if_app {
  async main(client) {
    ...
    header_title.expanded_content(`uxap`).label(`Example of an ObjectPage with header facet`);
    header_title.snapped_title_on_mobile().title(`Object Page Header with Header Container`);
    ...
    header_content.hbox({ class: `sapUiSmallMarginEnd sapUiSmallMarginBottom` })
      ...
      .link({ text: `John Miller`, class: `sapUiSmallMarginBegin` })
      .get_parent()
      .hbox({ class: `sapUiTinyMarginBottom` })
      .icon({ src: `sap-icon://outgoing-call` })
      .link({ text: `+1 234 5678`, class: `sapUiSmallMarginBegin` })
      .get_parent()
      .hbox({ class: `sapUiTinyMarginBottom` })
      .icon({ src: `sap-icon://email` })
      .link({ text: `john.miller@company.com`, class: `sapUiSmallMarginBegin` })
      .get_parent()
      .get_parent()
      .vbox(`sapUiSmallMarginEnd sapUiSmallMarginBottom`)
      .hbox({ class: `sapUiTinyMarginBottom` })
      ...
      .get_parent()
      .hbox({ class: `sapUiTinyMarginBottom` })
      .label({ text: `Changed By:`, class: `sapUiSmallMarginEnd` })
      .link({ text: `John Mille` })
      .get_parent()
      .hbox({ class: `sapUiTinyMarginBottom` })
      .label({ text: `Changed On:`, class: `sapUiSmallMarginEnd` })
      .text(`February 20, 2020`)
      .get_parent()
      .get_parent()
      .vbox(`sapUiSmallMarginEnd sapUiSmallMarginBottom`)
      .title({ text: `Product Description`, class: `sapUiTinyMarginBottom` })
      .text({ width: `320px`, text: `Top-design high-quality coffee mug - ideal for a comforting moment; Pack: 6; material: ` + `Porcelain - durable dishwasher and microwave-safe porcelain that cleans easily and is ideal for everyday service. Comes in two bright colors.` })
      .get_parent()
      .vbox(`sapUiSmallMarginEnd sapUiSmallMarginBottom`)
      .title({ class: `sapUiTinyMarginBottom` })
      .get()
      ...
      .get_parent()
      .vbox(`sapUiSmallMarginEnd sapUiSmallMarginBottom`)
      .title({ text: `Price`, class: `sapUiTinyMarginBottom` })
      .object_status({ text: `579 EUR`, class: `sapMObjectStatusLarge` })
      .get_parent()
      .get_parent()
      .vbox(`sapUiSmallMarginEnd sapUiSmallMarginBottom`)
      .title({ class: `sapUiTinyMarginBottom` })
      ...
      .get_parent()
      .label(`6 Reviews`)
      .rating_indicator({ value: `4`, iconsize: `16px` })
      .get_parent()
      .vbox({ alignitems: `End` })
      .text(`4.1 out of 5`);
    const section = object_page_layout.sections();
    section.object_page_section({ titleuppercase: false, id: `goalsSection`, title: `2014 Goals Plan` })
      .sub_sections()
      .object_page_sub_section({ id: `goalsSectionSS1`, titleuppercase: false })
      .blocks()
      .simple_form({ editable: false, layout: `ColumnLayout`, width: `100%`, columnsm: `2`, columnsl: `3`, columnsxl: `4`, labelspanl: `12` })
    ...
    section.object_page_section({ titleuppercase: false, id: `personalSection`, title: `Personal`, importance: `Medium` })
      .sub_sections()
      .object_page_sub_section({ id: `personalSectionSS1`, titleuppercase: false, title: `Connect` })
      .blocks()
      .simple_form({ editable: false, layout: `ColumnLayout`, width: `100%`, columnsm: `2`, columnsl: `3`, columnsxl: `4`, labelspanl: `12` })
      ...
      .get_parent()
      .get_parent()
      .object_page_sub_section({ id: `personalSectionSS2`, titleuppercase: false, title: `Payment Information` })
      .blocks()
      .simple_form({ editable: false, layout: `ColumnLayout`, width: `100%`, columnsm: `1`, columnsl: `2`, columnsxl: `3`, labelspans: `12`, labelspanm: `12`, labelspanl: `12`, labelspanxl: `12` })
      ...
      .text(`Cash 100 USD`);
    section.object_page_section({ titleuppercase: false, id: `employmentSection`, title: `Employment` })
      .sub_sections()
      .object_page_sub_section({ id: `employmentSectionSS1`, titleuppercase: false, title: `Job information` })
      .blocks()
      .simple_form({ id: `jobinfopart1`, editable: false, layout: `ColumnLayout`, width: `100%`, columnsm: `2`, columnsl: `3`, columnsxl: `4`, labelspans: `12`, labelspanm: `12`, labelspanl: `12`, labelspanxl: `12` })
      ...
      .text(`Developer`)
      .get_parent()
      .simple_form({ id: `jobinfopart2`, editable: false, layout: `ColumnLayout`, width: `100%`, columnsm: `2`, columnsl: `3`, columnsxl: `4`, labelspans: `12`, labelspanm: `12`, labelspanl: `12`, labelspanxl: `12` })
      ...
      .get_parent()
      .get_parent()
      .object_page_sub_section({ id: `employmentSectionSS2`, titleuppercase: false, title: `Employee Details` })
      .blocks()
      .simple_form({ id: `empdetailpart1`, editable: false, layout: `ColumnLayout`, width: `100%`, columnsm: `1`, columnsl: `1`, columnsxl: `2`, labelspans: `12`, labelspanl: `12` })
      ...
      .get_parent()
      .more_blocks()
      .simple_form({ id: `empdetailpart2`, editable: false, layout: `ColumnLayout`, width: `100%`, columnsm: `2`, columnsl: `3`, columnsxl: `4`, labelspans: `12`, labelspanl: `12` })
      .label(`Start Date`)
      .text(`Jan 01, 2001`)
      .label(`End Date`)
      .text(`Jun 30, 2014`)
      ...
      .text(`Jun 01, 2014`)
      .get_parent()
      .simple_form({ id: `empdetailpart3`, editable: false, layout: `ColumnLayout`, width: `100%`, columnsm: `2`, columnsl: `3`, columnsxl: `4`, labelspans: `12`, labelspanl: `12` })
      .label(`Payroll End Date`)
      .text(`Jan 01, 2014`)
...
module.exports = z2ui5_cl_smp_app_303;
