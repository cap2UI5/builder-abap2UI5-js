...
class z2ui5_cl_smp_app_421 extends z2ui5_if_app {
  ...
  view_display() {
    ...
    for (const row of this.t_tab) {
      ...
      items.column_list_item()
        .cells()
        .text(`${row.index}`)
        .input({ id: `${z2ui5_cl_smp_app_421.cs_column.title}_${i}`, value: `{${path}/${i}/TITLE}`, submit: this.client._event(`NEXT`) })
        .input({ id: `${z2ui5_cl_smp_app_421.cs_column.color}_${i}`, value: `{${path}/${i}/VALUE}`, submit: this.client._event(`NEXT`) })
        .input({ id: `${z2ui5_cl_smp_app_421.cs_column.info}_${i}`, value: `{${path}/${i}/INFO}`, submit: this.client._event(`NEXT`) })
        .checkbox({ id: `${z2ui5_cl_smp_app_421.cs_column.checkbox}_${i}`, selected: `{${path}/${i}/CHECKBOX}` })
        .input({ id: `${z2ui5_cl_smp_app_421.cs_column.description}_${i}`, value: `{${path}/${i}/DESCRIPTION}`, submit: this.client._event(`NEXT`) });
    }
  ...
  read_focus() {
    ...
    if (row && [...String(row)].every(($c) => String(`0123456789`).includes($c)) && (col === z2ui5_cl_smp_app_421.cs_column.title || col === z2ui5_cl_smp_app_421.cs_column.color || col === z2ui5_cl_smp_app_421.cs_column.info || col === z2ui5_cl_smp_app_421.cs_column.checkbox || col === z2ui5_cl_smp_app_421.cs_column.description)) {
