...
class z2ui5_cl_smp_app_315 extends z2ui5_if_app {
  async main(client) {
    let view;
    let page;
    let tab;
    if (client.check_on_init()) {
      ...
      client.follow_up_action(z2ui5_if_client.cs_event.set_odata_model, [`/sap/opu/odata/DMO/API_TRAVEL_U_V2/`, `TRAVEL`]);
      client.follow_up_action(z2ui5_if_client.cs_event.set_odata_model, [`/sap/opu/odata/DMO/ui_flight_r_v2/`, `FLIGHT`]);
    }
  }
}

module.exports = z2ui5_cl_smp_app_315;
