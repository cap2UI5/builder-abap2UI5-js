...
class z2ui5_cl_smp_app_458 extends z2ui5_if_app {
  amount = 0;
  client = null;
  ...
  view_display() {
    ...
    page.vbox(`sapUiSmallMargin`)
      ...
      .input({ width: `12rem`, value: `{ path: '${this.client._bind(this.amount, { path: true })}', ` + `type: 'sap.ui.model.type.Integer' }` });
...
module.exports = z2ui5_cl_smp_app_458;
