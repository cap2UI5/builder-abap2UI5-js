  ...
  async main(client) {
    ...
    switch (client.get().EVENT) {
      case `BUTTON_OPEN_NEW_TAB`:
        ...
        result = z2ui5_cl_a2ui5_context.app_get_url({ classname: `z2ui5_cl_smp_app_073`, origin: ls_config.ORIGIN, pathname: ls_config.PATHNAME, search: ls_config.SEARCH, hash: ls_config.HASH });
