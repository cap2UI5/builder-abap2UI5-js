...
class z2ui5_cl_smp_app_052 extends z2ui5_if_app {
  ...
  popover_display({ id } = {}) {
    ...
    const popover = lo_popover.ele(`Popover`)
      .a({ n: `title`, t: `abap2UI5 - Popover - ${this.mv_product}` })
    ...
    this.client.follow_up_action(this.client.cs_event.control_by_id, [`btn_details`, `focus`], this.client.cs_view.popover);
  }
  ...
  view_display() {
    ...
    page.tag(`MessageStrip`)
      .a({ n: `text`, v: `List report layout: a dynamic page with a table whose product links open a popover ` + `showing details for the selected row. After it opens, a follow_up_action scoped to ` + `cs_view-popover puts the focus on its details button.` })
