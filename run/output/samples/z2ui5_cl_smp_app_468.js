...
class z2ui5_cl_smp_app_468 extends z2ui5_if_app {
  ...
  on_event() {
    switch (this.client.get_event()) {
      ...
      case `GO_DETAIL`:
        ...
        break;
      case `ROUTING`:
        this.client.follow_up_action(this.client.cs_event.hash_routing, [((this.routing === true || this.routing === `X`) ? this.client.cs_nav_mode.fresh : this.client.cs_nav_mode.default)]);
        this.client.message_toast_display(((this.routing === true || this.routing === `X`) ? `routing mode fresh - the URL carries the class` : `routing mode default - the URL is left untouched`));
        break;
    }
  }
  ...
  view_display() {
    if (this.client.check_on_init()) {
      this.routing = true;
      this.client.follow_up_action(this.client.cs_event.hash_routing, [this.client.cs_nav_mode.fresh]);
    }
    ...
    form.tag(`Label`).a({ n: `text`, v: `3. Or switch the routing off again (mode default)` });
    form.tag(`Switch`)
      .a({ n: `state`, v: this.client._bind(this.routing) })
      .a({ n: `customTextOn`, v: `fresh` })
      .a({ n: `customTextOff`, v: `off` })
      .a({ n: `change`, v: this.client._event(`ROUTING`) });
    page.tag(`MessageStrip`)
      .a({ n: `text`, v: `fresh: the URL carries the class only (#/app/<CLASS>). After the detail page, the ` + `browser Back button starts this app FRESH - input and counter are reset.` })
      .a({ n: `type`, v: `Success` })
      .a({ n: `showIcon`, b: true })
      .a({ n: `class`, v: `sapUiSmallMargin` });
